...
namespace AndreasReitberger.API.Moonraker.Models
{
    public class KlipperTemperatureSensorStatesChangedEventArgs : Print3dBaseEventArgs
    {
        ...
        #region Overrides
        public override string ToString() => JsonSerializer.Serialize(this!, MoonrakerClientSourceGenerationContext.Default.KlipperTemperatureSensorStatesChangedEventArgs);
        #endregion
    }
}
